...
class ExcelToClickHouse:
    ...
    def process_excel_in_chunks(self, excel_path, chunk_size=10000):
        ...
        try:
            ...
            logging.info(f"CSV文件处理完成，共插入 {total_rows} 行数据到表 {self.table_name}")
            return total_rows
...
if __name__ == "__main__":
    ...
    TABLE_NAME = 'capture'  # 目标表名

    EXCEL_PATH = r"C:\Users\13106\Desktop\tmp\csv\capture.csv"  # Excel文件路径
